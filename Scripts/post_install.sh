...
# NOTE! NOTE! NOTE!
# NOTE! NOTE! NOTE!
# this issue is a Work In Progress still - the "fix" is to simply disable firewalld
...
# I encountered an issue with Red Hat's CDN (or mirrors?) when I tried this - so... try the first command, then the 2nd if the first does not work
sudo dnf update -y
